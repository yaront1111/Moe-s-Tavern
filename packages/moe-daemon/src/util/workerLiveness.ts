 ...
 * is the *presence* timeout (used for claimability + UI/agent display) — it is
 ...
 * its lastActivityAt is fresher than timeoutMs. Shared by isTaskClaimable,
 * listWorkers, chat_who and the sweeps so presence is computed identically
 * everywhere. Do not re-implement this check inline.
 */
